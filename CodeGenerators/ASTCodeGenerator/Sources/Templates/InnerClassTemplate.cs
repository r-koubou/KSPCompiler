...
namespace KSPCompiler.Apps.ASTCodeGenerator.Templates
{
    ...
    public partial class InnerClassTemplate : InnerClassTemplateBase
    {
#line hidden
        /// <summary>
 ...
 if( !string.IsNullOrEmpty( nodeClass.Description ) ) {
            ...
            #line hidden
            this.Write("    /// <summary>\n    /// ");
            this.Write(this.ToStringHelper.ToStringWithCulture(nodeClass.Description));
 ...
 if( !string.IsNullOrEmpty( attribute ) ) {
            ...
            #line default
            #line hidden
            this.Write(this.ToStringHelper.ToStringWithCulture(hasBaseClass ? $" : {baseClass}" : ""));
 ...
 if( hasMethod ) {
   ...
   PopIndent();
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class InnerClassTemplateBase
    {
        #region Fields
