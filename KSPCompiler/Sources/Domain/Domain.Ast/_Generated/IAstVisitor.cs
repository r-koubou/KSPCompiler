...
namespace KSPCompiler.Domain.Ast
{
    public interface IAstVisitor<out T>
    {
        ...
        public T Visit( AstPrimitiveInititalizer node );
        ...
        public T Visit( AstAdditionAssignmentExpression node );
        public T Visit( AstSubtractionAssignmentExpression node );
        public T Visit( AstMultiplyingAssignmentExpression node );
        public T Visit( AstDivisionAssignmentExpression node );
